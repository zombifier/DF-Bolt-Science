-- Displays announcements in the DFHack console. Modified to also write to combat_logs.txt
--@ enable = true
--[====[

devel/annc-monitor
==================
Displays announcements and reports in the console as well as write to combat_logs.txt

:enable|start:      Begins monitoring, clears out combat_logs.txt
:disable|stop:      Stops monitoring, writes everything to combat_logs.txt
